...
class AddFEM_ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    /// when the done button is pressed, run validation for input, if correct create a new object of FEM and add it to the target area specified by user, if incorrect activate empty field alert
